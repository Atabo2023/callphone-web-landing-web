...
<div className="w-full flex bg-white mb-10">
        <div className="flex gap-24">
          ...
          <img className="absolute top-[63rem] left-36" src={image3Image} alt="cardImg" />


    <div className="flex flex-col justify-end mb-20">
          {/* <div className="flex items-start flex-col justify-center"> */} 
            {/* {/* <div className="flex w-[678px] h-[244px] p-[10px] gap-[10px]"> */}
            <h1 className="text-7xl leading-[1.3] mb-4 font-bold text-dark_purple">
          ...
          {/* <div className="flex flex-col gap-10"> */}
            <div className="flex flex-col items-end justify-left relative bottom-[5rem] right-[27rem]">
