    ...
    <div className="lg:px-28 px-2">
      {/* <div className="flex mt-20"> */}
        <div className="lg:flex-row  flex flex-col-reverse ">          
          <div className="font-normal lg:w-1/2  lg:my-2 py-4 text-[#000000] tracking-wide leading-loose text-lg">
            <p className="text-4xl lg:py-5 px-3 font-semibold">About Callphone</p>
      ...
      <div className="lg:flex mt-20 lg:mt-0">
        ...
        <div className=" w-full lg:p-5 p-3 text-justify ">
          <div className="font-normal lg:mx-10 py-4 text-[#000000] tracking-wide leading-relaxed text-lg">
          ...
          <div className="font-normal lg:mx-10  py-4  text-[#000000] tracking-wide leading-relaxed text-lg">
            <p className="text-4xl md:p-5 font-semibold">Our Mission</p>
            <p className=" w-full">
              Our technical service team is equipped with the necessary skills
              to support our national footprint and roll-out of all POS
              ...
              customer-centric products actualizing CBN’s financial inclusion
              goal in line with the National Financial Inclusion Strategy. These
